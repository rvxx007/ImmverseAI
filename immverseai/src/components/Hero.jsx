    ...
    <section id='company' className='hero-section '>
        <div className="hero-parent1">
            <div className="hero-parent1-div1">
              <h1 className={`hero-headTxt ${orbitron}`}>{appData.hero.headTxt}</h1>
              ...
              <div className='hero-users-div'>
                <span className='span-block-upic'>{appData.hero.ui.map((item, index)=><span key={index}><Image  className='users-img' width={40} height={40} src={item} alt='mini profiles' /></span>)}</span> <span className='white-dot'> </span> <span className='eTxt'>{appData.hero.eTxt}</span>
              </div>
            </div>
            <div className='hero-cvr-img-div'>
        ...
        <div className="div4">
              <h1 className={`hero-headTxt1 ${orbitron} `}>{appData.hero.headTxt1}</h1>
